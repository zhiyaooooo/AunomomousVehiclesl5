...
struct B_l5_T {
  real_T err;                          // '<Root>/a_err'
  SL_Bus_l5_std_msgs_Float64 In1;      // '<S7>/In1'
  SL_Bus_l5_std_msgs_Float64 In1_o;    // '<S6>/In1'
};
...
struct P_l5_T_ {
  ...
  real_T alpha1_Value;                 // Expression: 2
                                          //  Referenced by: '<Root>/alpha1'

  real_T desiredtimegap1_Value;        // Expression: 2.5
                                          //  Referenced by: '<Root>/desired time gap1'
...
//  '<S4>'   : 'l5/Subscribe1'
//  '<S5>'   : 'l5/Subscribe2'
//  '<S6>'   : 'l5/Subscribe1/Enabled Subsystem'
//  '<S7>'   : 'l5/Subscribe2/Enabled Subsystem'
